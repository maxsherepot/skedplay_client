        ...
        <div className="px-3 w-full md:w-1/2 mb-5">
            <div className="p-5 border-light-grey border rounded-lg shadow h-full">
                ...
                <div className="flex flex-wrap justify-end -mx-2">
                    <div className="px-2">
                        <Link as={`/account/club/${cid}/events/${event.id}`} href={`/account/club/cid/events/eid?cid=${cid}&eid=${event.id}`}>
                            <a>
...
const EventList = ({events, club, removeEvent}) => {
    ...
    return (
        <>
            ...
            <Link href={`/account/club/cid/events/create?cid=${club.id}`} as={`/account/club/${club.id}/events/create`}>
                <a>
                    <Button
                      className="px-3"
                      level="primary-black"
