  ...
  const contentColumn = (
    <>
      <div className="flex -mx-3">
        ...
        <div className="w-2/5 px-3 hidden lg:block">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap -mx-3">
                ...
                <div className="w-full lg:w-2/5 sm:px-3 pb-6" >
                  {/*<div className="text-2xl font-extrabold my-5">{t('employees.gallery')}</div>*/}
                  <div className="hidden sm:block">
                    {sidebarColumn}
                  </div>
                </div>
                <div className="w-full px-3 block sm:flex block lg:hidden justify-center mb-5">
                  <CurrentLocation user={user} employee={employee} mapRef={mapRef} />
                </div>
