    ...
    return (
        <div className="w-3/12 px-2 mb-4">
            <div className="flex flex-col items-center px-3 py-2 border border-divider rounded-lg">
                ...
                <div className="text-center text-lg font-medium mt-4" style={{ width: "min-content", display: "table-caption" }}>{employee.name}</div>
